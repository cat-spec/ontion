          ...
          <div class="grid grid-cols-1 gap-4 md:grid-cols-2 2xl:grid-cols-3">
            ...
            >
              <div class="flex min-w-0 items-center gap-3">
                ...
                <span
                  class="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-white text-xs font-bold shadow-sm ring-1 ring-slate-200"
                ...
                >
                  ...
                  />
                  <span v-else>{{ platform.badge }}</span>
                </span>

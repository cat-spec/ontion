...
const platformIconUrls = {
  douyin: new URL('@/assets/platform-icons/douyin.ico', import.meta.url).href,
  whatsapp: new URL('@/assets/platform-icons/whatsapp.svg', import.meta.url).href,
  telegram: new URL('@/assets/platform-icons/telegram.svg', import.meta.url).href,
  telegramk: new URL('@/assets/platform-icons/telegramk.svg', import.meta.url).href,
...
export const useClientStore = defineStore('client', () => {
  ...
  const platforms: PlatformItem[] = [
    { id: 'douyin', name: '抖音聊天', badge: 'DY', color: '#0f172a', iconUrl: platformIconUrls.douyin, online: true },
    { id: 'whatsapp', name: 'WhatsApp', badge: 'WA', color: '#22c55e', iconUrl: platformIconUrls.whatsapp, online: true },
    { id: 'telegram', name: 'Telegram', badge: 'TG', color: '#0ea5e9', iconUrl: platformIconUrls.telegram, online: true },
    { id: 'telegramk', name: 'TelegramK', badge: 'TK', color: '#229ed9', iconUrl: platformIconUrls.telegramk, online: true },
  ]
